...
export function SalesPage() {
  ...
  const [sellerClientType, setSellerClientType] = useState<
    "Nuevo" | "Existente"
  >("Existente")
  ...
  const [sellerSource, setSellerSource] =
    useState<SaleSource>("Cliente existente")
  ...
  const { formRef: sellerFormRef, ...sellerErrors } = useApiFormErrors(
    createSellerSale.error
  )
  const { formRef: dirFormRef, ...dirErrors } = useApiFormErrors(
    createDirSale.error
  )
  const { formRef: atcFormRef, ...atcErrors } = useApiFormErrors(
    createAtcSale.error
  )
  ...
  const {
    ...
    isError,
  } = useSales(!isAdminOrDirector ? { sellerId } : {})
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div
        className={cn(
          "grid gap-4",
          isAdminOrDirector ? "grid-cols-2" : "grid-cols-1"
        )}
      >
        {/* Columna vendedor — solo Seller */}
        {!isAdminOrDirector && (
          <Card className="p-5">
            <h3 className="mb-4 text-sm font-black text-[#002B49]">
            ...
            >
              ...
              <div>
                ...
                <FieldError
                  name="clientId"
                  message={sellerErrors.fieldErrors.clientId}
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  value={sellerProduct}
                  onChange={(e) => {
                    setSellerProduct(e.target.value)
                    sellerErrors.clearField("product")
                  }}
                  placeholder="Nombre del producto"
                  required
                  {...fieldErrorProps(
                    "product",
                    sellerErrors.fieldErrors.product
                  )}
                />
                <FieldError
                  name="product"
                  message={sellerErrors.fieldErrors.product}
                />
              </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      sellerErrors.clearField("units")
                    }}
                    required
                    {...fieldErrorProps(
                      "units",
                      sellerErrors.fieldErrors.units
                    )}
                  />
                  <FieldError
                    name="units"
                    message={sellerErrors.fieldErrors.units}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      sellerErrors.clearField("amount")
                    }}
                    required
                    {...fieldErrorProps(
                      "amount",
                      sellerErrors.fieldErrors.amount
                    )}
                  />
                  <FieldError
                    name="amount"
                    message={sellerErrors.fieldErrors.amount}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <DatePickerField
                    ...
                    onChange={(v) => {
                      setSellerDate(v)
                      sellerErrors.clearField("date")
                    }}
                    {...fieldErrorProps("date", sellerErrors.fieldErrors.date)}
                  />
                  <FieldError
                    name="date"
                    message={sellerErrors.fieldErrors.date}
                  />
                </div>
                <div>
                  ...
                  <Select
                    value={sellerPay}
                    onValueChange={(v) => {
                      setSellerPay(v as PaymentMethod)
                      sellerErrors.clearField("pay")
                    }}
                  >
                    <SelectTrigger
                  ...
                  <FieldError
                    name="pay"
                    message={sellerErrors.fieldErrors.pay}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <Select
                  value={sellerSource}
                  onValueChange={(v) => {
                    setSellerSource(v as SaleSource)
                    sellerErrors.clearField("source")
                  }}
                >
                  <SelectTrigger
                    {...fieldErrorProps(
                      "source",
                      sellerErrors.fieldErrors.source
                    )}
                  >
                    <SelectValue />
                  </SelectTrigger>
                ...
                <FieldError
                  name="source"
                  message={sellerErrors.fieldErrors.source}
                />
              </div>
              ...
              <div>
                ...
                <FieldError
                  name="notes"
                  message={sellerErrors.fieldErrors.notes}
                />
              </div>
        ...
        {isAdminOrDirector && (
          <div className="rounded-xl bg-tracker-dark p-5">
            ...
            >
              ...
              <div>
                ...
                <Input
                  ...
                  {...fieldErrorProps(
                    "product",
                    dirErrors.fieldErrors.product ??
                      dirErrors.fieldErrors.clientName
                  )}
                />
                <FieldError
                  name="product"
              ...
              <div>
                ...
                <FieldError
                  name="units"
                  message={dirErrors.fieldErrors.units}
                />
              </div>
              ...
              <div>
                ...
                <FieldError
                  name="amount"
                  message={dirErrors.fieldErrors.amount}
                />
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  value={dirNotes}
                  onChange={(e) => {
                    setDirNotes(e.target.value)
                    dirErrors.clearField("notes")
                  }}
                  placeholder="Observaciones adicionales"
                ...
                <FieldError
                  name="notes"
                  message={dirErrors.fieldErrors.notes}
                />
              </div>
              ...
              >
                {createDirSale.isPending
                  ? "Guardando..."
                  : "Guardar Venta Dirección"}
              </Button>
            </form>
          </div>
        )}
        ...
        {isAdminOrDirector && (
          <Card className="p-5">
            <h3 className="mb-1 text-sm font-black text-[#002B49]">
              Registrar ATC
            </h3>
            <p className="mb-4 text-xs text-slate-500">
              ATC solo registra clientes existentes
            </p>
            <form
              ref={atcFormRef}
            ...
            >
              ...
              <div>
                ...
                <FieldError
                  name="units"
                  message={atcErrors.fieldErrors.units}
                />
              </div>
              ...
              <div>
                ...
                <FieldError
                  name="amount"
                  message={atcErrors.fieldErrors.amount}
                />
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  value={atcNotes}
                  onChange={(e) => {
                    setAtcNotes(e.target.value)
                    atcErrors.clearField("notes")
                  }}
                  placeholder="Observaciones adicionales"
                ...
                <FieldError
                  name="notes"
                  message={atcErrors.fieldErrors.notes}
                />
              </div>
          ...
          <div className="mb-4 grid grid-cols-2 gap-4 sm:grid-cols-4">
            ...
            <Card className="p-4">
              ...
              <p className="text-base font-bold text-[#002B49]">
                {summary.unitsByClientType.Nuevo} /{" "}
                {summary.unitsByClientType.Existente}
              </p>
              ...
              {data.data.map((sale) => (
                ...
                >
                  ...
                  <div className="ml-4 flex items-center gap-3">
                    <Badge
                      variant={sale.clientType === "Nuevo" ? "blue" : "gray"}
                    >
                      {sale.clientType}
                    </Badge>
                    <Badge
                          ...
                          <TooltipTrigger asChild>
                            <DropdownMenuTrigger asChild>
                              <Button
                                variant="ghost"
                                size="icon-xs"
                                aria-label={`Acciones de venta ${sale.clientName}`}
                              >
                                <MoreHorizontalIcon />
                              </Button>
                            </DropdownMenuTrigger>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ¿Eliminar la venta de <strong>{deletingSale?.clientName}</strong>?
