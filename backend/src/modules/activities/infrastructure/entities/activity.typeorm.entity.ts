...
export class ActivityTypeormEntity {
  ...
  @Column({ name: 'contact_id', type: 'varchar', nullable: true }) contactId:
    | string
    | null;
  @Column({ name: 'task_id', type: 'varchar', nullable: true }) taskId:
    | string
    | null;
  ...
  @Column({ name: 'next_step', type: 'text', nullable: true }) nextStep:
    | string
    | null;
  @Column({ name: 'next_objective', type: 'text', nullable: true })
  nextObjective: string | null;
  @Column({ name: 'next_date', type: 'varchar', nullable: true }) nextDate:
    | string
    | null;
  @Column({ name: 'next_time', type: 'varchar', nullable: true }) nextTime:
    | string
    | null;
  ...
  @Column({ name: 'programmed_at', type: 'timestamptz', nullable: true })
